...
// @ts-ignore
const font_awesome_css_inline_1 = __importDefault(require("https://cdn.staticfile.org/font-awesome/4.7.0/css/font-awesome.css?inline"));
...
class myDiv extends base_js_1.default {
    close;
    config;
    ClassInstance;
    /**
    ...
    connectedCallback() {
        ...
        this.adoptedStyle(font_awesome_css_inline_1.default);
    }
    // 重要4:能力增强
    /**
