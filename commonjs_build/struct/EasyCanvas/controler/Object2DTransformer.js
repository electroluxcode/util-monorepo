...
exports.Object2DTransformer = void 0;
const Matrix3_js_1 = require("../math/Matrix3.js");
const Vector2_js_1 = require("../math/Vector2.js");
class Object2DTransformer {
    /* 本地变换数据 */
    localMatrix = new Matrix3_js_1.Matrix3();
    localRotate = 0;
    localScale = new Vector2_js_1.Vector2(1, 1);
    localPosition = new Vector2_js_1.Vector2();
    /* 本地坐标系内的变换基点 */
    origin = new Vector2_js_1.Vector2();
    /* 相对变换量 */
    relativePosition = new Vector2_js_1.Vector2();
    relativeRotate = 0;
    relativeScale = new Vector2_js_1.Vector2(1, 1);
    /* 等量旋转时的旋转弧度 */
    ...
    get matrix() {
        ...
        const m2 = new Matrix3_js_1.Matrix3().makeTranslation(-origin.x, -origin.y);
        const m3 = new Matrix3_js_1.Matrix3()
    ...
    getRelativeScale(start2Orign, end2Orign) {
        ...
        return new Vector2_js_1.Vector2(a.x / b.x, a.y / b.y);
    }
    /* 双向自由缩放 */
