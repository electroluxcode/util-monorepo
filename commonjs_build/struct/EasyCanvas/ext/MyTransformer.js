...
class MyTransformer {
    ...
    /* 图案的变换基点 */
    orign = new Vector2_js_1.Vector2();
    /* 图案父级坐标系里的鼠标数据 */
    // 鼠标位置
    mousePos = new Vector2_js_1.Vector2();
    // 鼠标起始位
    mouseStart = new Vector2_js_1.Vector2();
    // mouseStart减orign
    originToMouseStart = new Vector2_js_1.Vector2();
    /* 等量旋转时的旋转弧度 */
...
exports.MyTransformer = MyTransformer;
