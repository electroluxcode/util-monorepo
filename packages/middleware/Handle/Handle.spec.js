...
describe("Handle", () => {
	...
	test("groupBy/*", () => {
		...
		let expectData = {
			3: [{ id: 1, children: { id: 3 } }],
			14: [{ id: 1, children: { id: 14 } }],
			19: [{ id: 2, children: { id: 19 } }],
		};
	...
	test("transform/*", () => {
		...
		let transformInstance = new Handle(data)
			.transformBy({ key: transformByFn })
			.execute();
		let expectData = [
			{ id: 1, children: { id: 14 }, a: 14 },
			{ id: 2, children: { id: 19 }, a: 19 },
			{ id: 1, children: { id: 3 }, a: 3 },
		];
