...
export const useDict = async (timeExpire = 1000 * 3) => {
	...
	const getDictMagicNumberByKey = (
		type: dictType
	): { CnToValue: any; ValueToCn: any; EnToValue: any; ValueToEn: any } => {
...
// let base = await useDict(3000);

// // ApiSelect 等组件可用
// console.log(base.getDictArrayByKey("envEquipType"));
// // submit 和table回显的时候可用
// base.getDictMagicNumberByKey("envEquipType")["CnToValue"]["设备0"];
export {};
