 ...
 * @returns
 */
async function handleReturnType(result, config) {
...
export class easyFetch {
    ...
    async request(config) {
        ...
        let { requestInterceptors, requestInterceptorsCatch, responseInterceptors, responseInterceptorsCatch, } = config?.transform ?? {};
