...
// cssStyle.innerHTML = cssStyle.innerHTML + B;
// cssStyle.innerHTML = cssStyle.innerHTML + L;
// cssStyle.innerHTML = cssStyle.innerHTML + R;
// cssStyle.innerHTML = cssStyle.innerHTML + T;
...
class button extends Base {
	...
	constructor() {
		...
		let pop = this.shadowRootInit.querySelector("#pop")! as any;
		// 需要被触发的元素
		let target = document.querySelector(".target") as any;
