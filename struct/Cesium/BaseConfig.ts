...
const licenseKeys = {
  ...
  cesiumion:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIyM2EzMjhiMC1mOGEyLTRhYjQtYjhjZS0yMjQ5MjljYzY4YmIiLCJpZCI6MTE2MjI0LCJpYXQiOjE2Njk1MjkzMDl9.aNc-57uNs9TANanaWkLdtBocACcrosZiQO-NXmCaARA',
};
...
export const defaultData = { x: 108, y: 22, z: 10 };
